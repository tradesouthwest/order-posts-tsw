 ...
 */
class Order_Posts_Tsw_Widget extends WP_Widget {

	function __construct() {
    parent::__construct(
    // Base ID of widget
    'Order_Posts_Tsw_Widget',

    // Widget name will appear in UI
    __( 'Ordered Posts', 'order-posts-tsw' ), // Name
	array(
        'description' => __( 'Adds Widget for order-posts-tsw Plugin',
                            'order-posts-tsw' ),
        ));
	}
...
} // Ends class optsw_Widget

// Register and load the widget
	function optsw_load_widget() {
		register_widget( 'Order_Posts_Widget' );
}

add_action( 'widgets_init', 'optsw_load_widget' );
?>